...
const allNavItems = [
  ...
  // The AI assistant gate: operator+ can review/approve drafts (never auto-sends while the gate is on).
  { to: '/ai-approvals', icon: Bot, key: 'ai' as const, adminOnly: false },
      ...
      {isMobile && (
        <header className="mobile-header">
          ...
          <div className="mobile-brand">
            <img src="/logo.png" alt="WAA" className="sidebar-logo" />
